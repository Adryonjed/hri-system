...
def edit_file(s_id):
    ...
    idl = customtkinter.CTkEntry(f_frame, textvariable=ids,height= 35,width=100, fg_color='white',border_width = 2, font=('Arial', 22),corner_radius= 10,text_color='black',validate='key',validatecommand=(my_valid2,'%S'))
    ...
    fn = customtkinter.CTkEntry(f_frame, textvariable=fnamee, height= 35, width=450, fg_color='white',border_width = 2, corner_radius= 10, font=('Arial', 22),text_color='black')
    ...
    sn = customtkinter.CTkEntry(f_frame,textvariable=snamee, height= 35,width=450, fg_color='white',border_width = 2,font=('Arial', 22), corner_radius= 10,text_color='black')
    ...
    hover_color = '#2a4859',cursor='hand2',command=updtfile)
