...
def record():
   ...
   p_sex = tk.StringVar()
   p_civ = tk.StringVar()
   p_height = tk.StringVar()
   p_weight = tk.StringVar()
   p_bt = tk.StringVar()
   p_citi = tk.StringVar()
   p_ifdc = tk.StringVar()
   p_coun = tk.StringVar()
...
#===================Graduate studies
   ...
   def add_e():
      ...
      cv = Canvas(f2_1,background='#aee0e8',highlightthickness=0)
   ...
   #-------------------------------------------------------------------------------------------------------------------------------------#
      ...
      dobentry = DateEntry(sf, height= 35, width=15, font = ('arial', 22),date_pattern='mm/dd/y', background='gray', foreground='white', borderwidth=0, weekendbackground ="red",bd = 0)
      dt = date(2023,1,1)
      dobentry.set_date(dt)
      ...
      sexx = tk.StringVar()
      stat1 = customtkinter.CTkRadioButton(sf, text="Male", radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='male',bg_color ="#8ed1ba",variable=sexx, cursor='hand2', font=('Courier', 16, 'bold'),text_color='black').place(x=280,y= 350)
      stat2 = customtkinter.CTkRadioButton(sf, text="Female",radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='female',bg_color ="#8ed1ba",variable=sexx, cursor='hand2',font=('Courier', 16, 'bold'),text_color='black').place(x=380,y= 350)
      sexx.set(None)
      ...
      wtlabel = Label(sf, text="7.WEIGHT (kg) :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=500)
      ...
      tlabel = Label(sf, text="15.TELEPHONE NO. : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=900)
      ...
      clabel = Label(sf, text="16.CELLPHONE NO. : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=950)
      ...
      ctlabel = Label(sf, text="17.CITIZENSHIP :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=750, y=250)
      ctz = tk.StringVar()
      ct3 = customtkinter.CTkRadioButton(sf, text="Filipino", radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='Filipino',bg_color ="#8ed1ba",variable=ctz, cursor='hand2', font=('Courier', 16, 'bold'),text_color='black',command=fr).place(x=990,y= 250)
      ct4 = customtkinter.CTkRadioButton(sf, text="Dual Citizenship",radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='Dual Citizenship',bg_color ="#8ed1ba",variable=ctz, cursor='hand2',font=('Courier', 16, 'bold'),text_color='black',command=gt).place(x=1130,y= 250)
      ctz.set(None)
      ...
      ralabel = Label(sf, text="18.RESIDENTIAL ADDRESS :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=750, y=450)
      ...
      ra7Entry = customtkinter.CTkEntry(sf,height= 35, width=125, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ra7Entry.place(x=900, y=660)

      palabel = Label(sf, text="19.PERMANENT ADDRESS :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=750, y=700)
      pa1label = Label(sf, text="HouseBlock/Lot No.", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=930, y=760)
      pa1Entry = customtkinter.CTkEntry(sf,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ...
      pa7Entry = customtkinter.CTkEntry(sf,height= 35, width=125, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      pa7Entry.place(x=900, y=910)

      elabel = Label(sf, text="20.EMAIL ADDRESS: ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=753, y=950)
   ...
   #-------------------------------------------------------------------------------------------------------------------------------------#
      ...
      spolabel = Label(sf, text="21.SPOUSE'S SURNAME: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1052)
      ...
      fspolabel = Label(sf, text="   FIRST NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1100)
      ...
      mspolabel = Label(sf, text="   MIIDDLE NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1150)
      ...
      oclabel = Label(sf, text="   OCCUPATION : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1200)
      ...
      ebmlabel = Label(sf, text="EMPLOYEE/\nBUSINESS NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba",justify= LEFT).place(x=48, y=1250)
      ...
      balabel = Label(sf, text="   BUSINESS ADDRESS: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1305)
      ...
      telelabel = Label(sf, text="   TELEPHONE NO. : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1350)
      teleEntry = customtkinter.CTkEntry(sf, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      teleEntry.place(x=230, y=1350)

      fsnlabel = Label(sf, text="22.FATHER'S SURNAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1052)
      ...
      ffnlabel = Label(sf, text="   FIRST NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1100)
      ...
      fmnlabel = Label(sf, text="   MIIDDLE NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1150)
      ...
      mmnlabel = Label(sf, text="23.MOTHER'S MAIDEN NAME: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1200)
      ...
      msnlabel = Label(sf, text="   SURNAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1250)
      ...
      mfnlabel = Label(sf, text="   FIRST NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1300)
      mfnEntry = customtkinter.CTkEntry(sf, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      mfnEntry.place(x=950, y=1300)

      mlabel = Label(sf, text="   MIDDLE NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1350)
   ...
   #-------------------------------------------------------------------------------------------------------------------------------------#
      ...
      lvllabel = Label(sf, text="Level", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=50, y=1450)
      NOSlabel = Label(sf, text="Name of School", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=310, y=1450)
      BEDClabel = Label(sf, text="Basic Education/Degree/Course", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=620, y=1450)
      POAlabel = Label(sf, text="Period of Attendance", font=('Courier', 10, 'bold'),bg="#8ed1ba").place(x=935, y=1450)
      frotolabel = Label(sf, text="From      To", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=947, y=1475)
      hillabel = Label(sf, text="Highest Level/\nUnits Earned\n(if not graduated)",justify= CENTER, font=('Courier', 9, 'bold'),bg="#8ed1ba").place(x=1105 , y=1445)
      YGGlabel = Label(sf, text="Year\nGraduated", font=('Courier', 11, 'bold'),bg="#8ed1ba").place(x=1245, y=1450)
      SAlabel = Label(sf, text="Scholarship/\nAcademic Honors\nReceived", font=('Courier', 10, 'bold'),bg="#8ed1ba").place(x=1345, y=1445)


      elabel = Label(sf, text="ELEMENTARY : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1500)
      ...
      froEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      froEntry.place(x=940, y=1500)

      toEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ...
      ygEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ygEntry.place(x=1240, y=1500)

      saEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      saEntry.place(x=1360, y=1500)


      hslabel = Label(sf, text="HIGHSCHOOL : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1550)
      ...
      hsfroEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hsfroEntry.place(x=940, y=1550)

      hstoEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ...
      hsygEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hsygEntry.place(x=1240, y=1550)

      hssaEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hssaEntry.place(x=1360, y=1550)


      vtlabel = Label(sf, text="VOCATIONAL/\nTRADE COURSE : ",justify = LEFT, font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1600)
      ...
      vtfroEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vtfroEntry.place(x=940, y=1600)

      vttoEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ...
      vtygEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vtygEntry.place(x=1240, y=1600)

      vtsaEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vtsaEntry.place(x=1360, y=1600)


      clabel = Label(sf, text="COLLEGE : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1650)
      ...
      cfroEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      cfroEntry.place(x=940, y=1650)

      ctoEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ...
      cygEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      cygEntry.place(x=1240, y=1650)

      csaEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      csaEntry.place(x=1360, y=1650)

      gslabel = Label(sf, text="GRADUATE STUDIES: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1700)
      ...
      gsfroEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gsfroEntry.place(x=940, y=1700)

      gstoEntry = customtkinter.CTkEntry(sf,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ...
      gsygEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gsygEntry.place(x=1240, y=1700)

      gssaEntry = customtkinter.CTkEntry(sf,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gssaEntry.place(x=1360, y=1700)


      roelabel = Label(sf, text="EMPLOYEE DETAILS", font=('Arial', 17, 'bold'),bg="#8ed1ba")
      roelabel.place(x=30, y=1750)

      polabel = Label(sf, text="POSITION : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=40, y=1800)
      poEntry = customtkinter.CTkEntry(sf, width=355, fg_color='white',border_width = 0 ,font=('Arial', 16,),text_color='black')
      poEntry.place(x=160, y=1800)

      stlabel = Label(sf, text="STATUS: ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=520, y=1800)
      stEntry = customtkinter.CTkEntry(sf, width=355, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      stEntry.place(x=610, y=1800)


      deabel = Label(sf, text="DEPARTMENT : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=980, y=1800)
      deEntry = customtkinter.CTkEntry(sf, width=355, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
   ...
   def modify_e():
      ...
      sf3 = customtkinter.CTkFrame(cv3, width=1500, height=2000 ,fg_color ="#b780c2")
      ...
      def update():
         ...
         if (sname == "" or sname == " ") or (fname == "" or  fname == " ") or (mname == "" or mname == " ") or (ct == "" or ct == " ") or (hei == "" or hei == " ") or (wei == "" or wei == " ") or (bt == "" or bt == " ") or (tlno == "" or tlno == " ") or (clno == "" or clno == " ") or (email == "" or email == " ") or (dobb == "" or dobb == " ") or (sex == "" or sex == " ") or (cs == "" or cs == " ") or (pos == "" or pos == " ") or (dept == "" or dept == " "):
               ...
               try:
                  conn = connection()
                  cursor = conn.cursor()
                  cursor.execute("UPDATE personal SET firstname='"+fname+"', middlename='"+mname+"', lastname='"+sname+"', sex='"+sex+"', DOB='"+dobb+"', citizenship='"+ct+"',civilstatus='"+cs+"',height='"+hei+"',weight='"+wei+"',bloodtype='"+bt+"',tellno='"+tlno+"',cellno='"+clno+"',email='"+email+"',position='"+pos+"',department='"+dept+"' WHERE id='"+jed+"' ")
                  conn.commit()
                  conn.close()
      ...
      titleabel = Label(sf3, text="PERSONAL DATA SHEET", font=('Arial', 22, 'bold'),bg="#8ed1ba")
      titleabel.place(x=690, y=10, anchor= N)

      sublabel = Label(sf3, text="PERSONAL INFORMATION ", font=('Arial', 18, 'bold'),bg="#8ed1ba")
      sublabel.place(x=30, y=50)

      snlabel = Label(sf3, text="1.SURNAME :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=100)
      ...
      fnlabel = Label(sf3, text="  FIRSTNAME :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=150)
      fnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0, font=('Arial', 22),text_color='black',textvariable=p_fname)
      fnEntry.place(x=280, y=150)

      mnlabel = Label(sf3, text="  MIDDLENAME :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=200)
      mnEntry = customtkinter.CTkEntry(sf3,  height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black',textvariable=p_mname)
      mnEntry.place(x=280, y=200)

      doblabel = Label(sf3, text="2.DATE OF BIRTH :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=252)
      dobentry2 = DateEntry(sf3, height= 35, width=15, font = ('arial', 22),date_pattern='mm/dd/y', background='gray', foreground='white', borderwidth=0, weekendbackground ="red",bd = 0)
      dobentry2.set_date(result[4])
      dobentry2.place(x=280, y= 250)

      poblabel = Label(sf3, text="3.PLACE OF BIRTH :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=302)
      pobEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black',textvariable=p_pob)
      pobEntry.place(x=280, y=300)

      sexlabel = Label(sf3, text="4.SEX : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=350)
      sexx = tk.StringVar()
      stat1 = customtkinter.CTkRadioButton(sf3, text="Male", radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='male',bg_color ="#8ed1ba",variable=sexx, cursor='hand2', font=('Courier', 16, 'bold'),text_color='black').place(x=280,y= 350)
      stat2 = customtkinter.CTkRadioButton(sf3, text="Female",radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='female',bg_color ="#8ed1ba",variable=sexx, cursor='hand2',font=('Courier', 16, 'bold'),text_color='black').place(x=380,y= 350)
      sexx.set(result[6])

      statuslabel = Label(sf3, text="5.CIVIL STATUS :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=400)
      civ = tk.StringVar()
      st = customtkinter.CTkOptionMenu(sf3,height= 35, width = 300,fg_color='white',font=('Arial', 22),dropdown_font = ('Courier', 16),dropdown_fg_color='white',dropdown_text_color = 'black',dropdown_hover_color = 'green', button_color = 'white',button_hover_color = 'gray',text_color = "black",variable = civ, values=["Single", "Married", "Widowed", "Seperated", "Other/s"])
      st.place(x=280, y= 400)
      st.set(result[7])

      hlabel = Label(sf3, text="6.HEIGHT (cm) :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=450)
      htEntry = customtkinter.CTkEntry(sf3,height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=p_height)
      htEntry.place(x=280, y=450)

      wtlabel = Label(sf3, text="7.WEIGHT (kg) :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=500)
      wtEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=p_weight)
      wtEntry.place(x=280, y=500)

      btlabel = Label(sf3, text="8.BLOOD TYPE :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=550)
      blo = tk.StringVar()
      bt = customtkinter.CTkOptionMenu(sf3,height= 35, width = 300,fg_color='white',font=('Arial', 22),dropdown_font = ('Courier', 16),dropdown_fg_color ='white',dropdown_text_color = 'black',dropdown_hover_color = 'green', button_color = 'white',button_hover_color = 'gray',text_color = "black", variable = blo, values=["A+", "A-", "B+", "B-", "O+", "O-", "AB+", "AB-"])
      bt.place(x=280, y= 550)
      bt.set(result[10])

      gslabel = Label(sf3, text="9.GSIS ID NO. :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=600)
      gsEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_gsis)
      gsEntry.place(x=280, y=600)

      paglabel = Label(sf3, text="10.PAG-IBIG ID NO. :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=650)
      pagEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_pag)
      pagEntry.place(x=280, y=650)

      phlabel = Label(sf3, text="11.PHILHEALTH NO. :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=700)
      phEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_phil)
      phEntry.place(x=280, y=700)

      sslabel = Label(sf3, text="12.SSS NO. :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=750)
      ssEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_sss)
      ssEntry.place(x=280, y=750)

      tilabel = Label(sf3, text="13.TIN NO. :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=800)
      tiEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_tin)
      tiEntry.place(x=280, y=800)

      aelabel = Label(sf3, text="14.AGENCY EMPLOYEE NO.:", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=850)
      aeEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_ae)
      aeEntry.place(x=280, y=850)

      tlabel = Label(sf3, text="15.TELEPHONE NO. : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=900)
      tEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_tel)
      tEntry.place(x=280, y=900)

      clabel = Label(sf3, text="16.CELLPHONE NO. : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=20, y=950)
      cEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black',textvariable=n_cel)
      cEntry.place(x=280, y=950)
      ...
      ctlabel = Label(sf3, text="17.CITIZENSHIP :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=750, y=250)
      ctz = tk.StringVar()
      ct3 = customtkinter.CTkRadioButton(sf3, text="Filipino", radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='Filipino',bg_color ="#8ed1ba",variable=ctz, cursor='hand2', font=('Courier', 16, 'bold'),text_color='black',command=fr).place(x=990,y= 250)
      ct4 = customtkinter.CTkRadioButton(sf3, text="Dual Citizenship",radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='Dual Citizenship',bg_color ="#8ed1ba",variable=ctz, cursor='hand2',font=('Courier', 16, 'bold'),text_color='black',command=gt).place(x=1130,y= 250)
      ctz.set(p_citi)

      optlabel = Label(sf3, text="if Dual Citizenship:", font=('Courier', 15, 'bold'),bg="#8ed1ba")
      optlabel.place(x=900, y=300)
      opt2 = tk.StringVar()
      ct5 = customtkinter.CTkRadioButton(sf3, text="By Birth", radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='By Birth',bg_color ="#8ed1ba",variable=opt2, cursor='hand2', font=('Courier', 16, 'bold'),text_color='black')
      ct5.place(x=1050,y= 350)
      ct6 = customtkinter.CTkRadioButton(sf3, text="By Naturalization",radiobutton_height= 30, radiobutton_width= 30, border_width_checked = 10, border_width_unchecked= 5, value='By Naturalization',bg_color ="#8ed1ba",variable=opt2, cursor='hand2',font=('Courier', 16, 'bold'),text_color='black')
      ct6.place(x=1190,y= 350)
      opt2.set(p_ifdc)

      coulabel = Label(sf3, text="your Country :", font=('Courier', 14, 'bold'),bg="#8ed1ba")
      coulabel.place(x=850, y=397)
      couEntry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black',textvariable=p_coun)
      couEntry.place(x=1025, y=395)


      ralabel = Label(sf3, text="18.RESIDENTIAL ADDRESS :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=750, y=450)
      ra1label = Label(sf3, text="HouseBlock/Lot No.", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=930, y=510)
      raEntry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black',textvariable=r_ra1)
      raEntry.place(x=900, y=480)

      ra2label = Label(sf3, text="Street", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=1270, y=510)
      ra2Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black',textvariable=r_ra2)
      ra2Entry.place(x=1180, y=480)

      ra3label = Label(sf3, text="Subdivision/Village", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=925, y=570)
      ra3Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ra3Entry.place(x=900, y=540)

      ra4label = Label(sf3, text="Barangay", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=1260, y=570)
      ra4Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ra4Entry.place(x=1180, y=540)

      ra5label = Label(sf3, text="City/Municipality", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=930, y=630)
      ra5Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ra5Entry.place(x=900, y=600)

      ra6label = Label(sf3, text="Province", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=1260, y=630)
      ra6Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ra6Entry.place(x=1180, y=600)

      ra7label = Label(sf3, text="ZIP CODE :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=785, y=665)
      ra7Entry = customtkinter.CTkEntry(sf3,height= 35, width=125, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ra7Entry.place(x=900, y=660)

      palabel = Label(sf3, text="19.PERMANENT ADDRESS :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=750, y=700)
      pa1label = Label(sf3, text="HouseBlock/Lot No.", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=930, y=760)
      pa1Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      pa1Entry.place(x=900, y=730)

      pa2label = Label(sf3, text="Street", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=1270, y=760)
      pa2Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      pa2Entry.place(x=1180, y=730)

      pa3label = Label(sf3, text="Subdivision/Village", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=925, y=820)
      pa3Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      pa3Entry.place(x=900, y=790)

      pa4label = Label(sf3, text="Barangay", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=1260, y=820)
      pa4Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      pa4Entry.place(x=1180, y=790)

      pa5label = Label(sf3, text="City/Municipality", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=930, y=880)
      pa5Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      pa5Entry.place(x=900, y=850)

      pa6label = Label(sf3, text="Province", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=1260, y=880)
      pa6Entry = customtkinter.CTkEntry(sf3,height= 35, width=250, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      pa6Entry.place(x=1180, y=850)

      pa7label = Label(sf3, text="ZIP CODE :", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=785, y=915)
      pa7Entry = customtkinter.CTkEntry(sf3,height= 35, width=125, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      pa7Entry.place(x=900, y=910)

      elabel = Label(sf3, text="20.EMAIL ADDRESS: ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=753, y=950)
      eEntry = customtkinter.CTkEntry(sf3,height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      eEntry.place(x=950, y=950)
   ...
   #-------------------------------------------------------------------------------------------------------------------------------------#
      ...
      fblabel = Label(sf3, text="FAMILY BACKGROUND", font=('Courier', 18, 'bold'),bg="#8ed1ba").place(x=30, y=1000)

      spolabel = Label(sf3, text="21.SPOUSE'S SURNAME: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1052)
      spoEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      spoEntry.place(x=230, y=1050)

      fspolabel = Label(sf3, text="   FIRST NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1100)
      fspoEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      fspoEntry.place(x=230, y=1100)

      mspolabel = Label(sf3, text="   MIIDDLE NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1150)
      mspoEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      mspoEntry.place(x=230, y=1150)

      oclabel = Label(sf3, text="   OCCUPATION : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1200)
      ocEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ocEntry.place(x=230, y=1200)

      ebmlabel = Label(sf3, text="EMPLOYEE/\nBUSINESS NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba",justify= LEFT).place(x=48, y=1250)
      ebmEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ebmEntry.place(x=230, y=1250)

      balabel = Label(sf3, text="   BUSINESS ADDRESS: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1305)
      baEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      baEntry.place(x=230, y=1300)

      telelabel = Label(sf3, text="   TELEPHONE NO. : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=20, y=1350)
      teleEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      teleEntry.place(x=230, y=1350)

      fsnlabel = Label(sf3, text="22.FATHER'S SURNAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1052)
      fsnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      fsnEntry.place(x=950, y=1050)

      ffnlabel = Label(sf3, text="   FIRST NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1100)
      ffnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      ffnEntry.place(x=950, y=1100)

      fmnlabel = Label(sf3, text="   MIIDDLE NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1150)
      fmnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      fmnEntry.place(x=950, y=1150)

      mmnlabel = Label(sf3, text="23.MOTHER'S MAIDEN NAME: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1200)
      mmnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      mmnEntry.place(x=950, y=1200)

      msnlabel = Label(sf3, text="   SURNAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1250)
      msnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      msnEntry.place(x=950, y=1250)

      mfnlabel = Label(sf3, text="   FIRST NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1300)
      mfnEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      mfnEntry.place(x=950, y=1300)

      mlabel = Label(sf3, text="   MIDDLE NAME : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=700, y=1350)
      mEntry = customtkinter.CTkEntry(sf3, height= 35, width=450, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      mEntry.place(x=950, y=1350)
   ...
   #-------------------------------------------------------------------------------------------------------------------------------------#
      ...
      eblabel = Label(sf3, text="EDUCATIONAL BACKGROUND", font=('Arial', 17, 'bold'),bg="#8ed1ba")
      eblabel.place(x=30, y=1400)

      lvllabel = Label(sf3, text="Level", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=50, y=1450)
      NOSlabel = Label(sf3, text="Name of School", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=310, y=1450)
      BEDClabel = Label(sf3, text="Basic Education/Degree/Course", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=620, y=1450)
      POAlabel = Label(sf3, text="Period of Attendance", font=('Courier', 10, 'bold'),bg="#8ed1ba").place(x=935, y=1450)
      frotolabel = Label(sf3, text="From      To", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=947, y=1475)
      hillabel = Label(sf3, text="Highest Level/\nUnits Earned\n(if not graduated)",justify= CENTER, font=('Courier', 9, 'bold'),bg="#8ed1ba").place(x=1105 , y=1445)
      YGGlabel = Label(sf3, text="Year\nGraduated", font=('Courier', 11, 'bold'),bg="#8ed1ba").place(x=1245, y=1450)
      SAlabel = Label(sf3, text="Scholarship/\nAcademic Honors\nReceived", font=('Courier', 10, 'bold'),bg="#8ed1ba").place(x=1345, y=1445)


      elabel = Label(sf3, text="ELEMENTARY : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1500)
      ensEntry = customtkinter.CTkEntry(sf3,  height= 35, width=400, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      ensEntry.place(x=200, y=1500)

      bdcEntry = customtkinter.CTkEntry(sf3,  height= 35, width=300, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      bdcEntry.place(x=620, y=1500)

      froEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      froEntry.place(x=940, y=1500)

      toEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      toEntry.place(x=1030, y=1500)

      hiEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      hiEntry.place(x=1120, y=1500)

      ygEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ygEntry.place(x=1240, y=1500)

      saEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      saEntry.place(x=1360, y=1500)


      hslabel = Label(sf3, text="HIGHSCHOOL : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1550)
      hsnsEntry = customtkinter.CTkEntry(sf3,  height= 35, width=400, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      hsnsEntry.place(x=200, y=1550)

      hsbdcEntry = customtkinter.CTkEntry(sf3,  height= 35, width=300, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      hsbdcEntry.place(x=620, y=1550)

      hsf3roEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hsf3roEntry.place(x=940, y=1550)

      hstoEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hstoEntry.place(x=1030, y=1550)

      hshiEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      hshiEntry.place(x=1120, y=1550)

      hsygEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hsygEntry.place(x=1240, y=1550)

      hssaEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      hssaEntry.place(x=1360, y=1550)


      vtlabel = Label(sf3, text="VOCATIONAL/\nTRADE COURSE : ",justify = LEFT, font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1600)
      vtnsEntry = customtkinter.CTkEntry(sf3,  height= 35, width=400, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      vtnsEntry.place(x=200, y=1600)

      vtbdcEntry = customtkinter.CTkEntry(sf3,  height= 35, width=300, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      vtbdcEntry.place(x=620, y=1600)

      vtfroEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vtfroEntry.place(x=940, y=1600)

      vttoEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vttoEntry.place(x=1030, y=1600)

      vthiEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      vthiEntry.place(x=1120, y=1600)

      vtygEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vtygEntry.place(x=1240, y=1600)

      vtsaEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      vtsaEntry.place(x=1360, y=1600)


      clabel = Label(sf3, text="COLLEGE : ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1650)
      cnsEntry = customtkinter.CTkEntry(sf3,  height= 35, width=400, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      cnsEntry.place(x=200, y=1650)

      cbdcEntry = customtkinter.CTkEntry(sf3,  height= 35, width=300, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      cbdcEntry.place(x=620, y=1650)

      cfroEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      cfroEntry.place(x=940, y=1650)

      ctoEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      ctoEntry.place(x=1030, y=1650)

      chiEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      chiEntry.place(x=1120, y=1650)

      cygEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      cygEntry.place(x=1240, y=1650)

      csaEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      csaEntry.place(x=1360, y=1650)

      gslabel = Label(sf3, text="GRADUATE STUDIES: ", font=('Courier', 12, 'bold'),bg="#8ed1ba").place(x=25, y=1700)
      gsnsEntry = customtkinter.CTkEntry(sf3,  height= 35, width=400, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      gsnsEntry.place(x=200, y=1700)

      gsbdcEntry = customtkinter.CTkEntry(sf3,  height= 35, width=300, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      gsbdcEntry.place(x=620, y=1700)

      gsf3roEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gsf3roEntry.place(x=940, y=1700)

      gstoEntry = customtkinter.CTkEntry(sf3,  height= 35, width=70, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gstoEntry.place(x=1030, y=1700)

      gshiEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),text_color='black')
      gshiEntry.place(x=1120, y=1700)

      gsygEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gsygEntry.place(x=1240, y=1700)

      gssaEntry = customtkinter.CTkEntry(sf3,  height= 35, width=100, fg_color='white',border_width = 0, font=('Arial', 16,),validate='key',validatecommand=(my_valid,'%S'),text_color='black')
      gssaEntry.place(x=1360, y=1700)


      roelabel = Label(sf3, text="EMPLOYEE DETAILS", font=('Arial', 17, 'bold'),bg="#8ed1ba")
      roelabel.place(x=30, y=1750)

      polabel = Label(sf3, text="POSITION : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=40, y=1800)
      poEntry = customtkinter.CTkEntry(sf3, width=355, fg_color='white',border_width = 0 ,font=('Arial', 16,),text_color='black')
      poEntry.place(x=160, y=1800)

      stlabel = Label(sf3, text="STATUS: ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=520, y=1800)
      stEntry = customtkinter.CTkEntry(sf3, width=355, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      stEntry.place(x=610, y=1800)


      deabel = Label(sf3, text="DEPARTMENT : ", font=('Courier', 14, 'bold'),bg="#8ed1ba").place(x=980, y=1800)
      deEntry = customtkinter.CTkEntry(sf3, width=355, fg_color='white',border_width = 0 ,font=('Arial', 22),text_color='black')
      deEntry.place(x=1120, y=1800)
